...
public class ggml_cplan {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        WhisperLib.C_LONG_LONG.withName("work_size"),
        WhisperLib.C_POINTER.withName("work_data"),
        WhisperLib.C_INT.withName("n_threads"),
        MemoryLayout.paddingLayout(4),
        WhisperLib.C_POINTER.withName("threadpool"),
        WhisperLib.C_POINTER.withName("abort_callback"),
        WhisperLib.C_POINTER.withName("abort_callback_data"),
        WhisperLib.C_BOOL.withName("use_ref"),
    ...
    private static final OfBoolean use_ref$LAYOUT = (OfBoolean)$LAYOUT.select(groupElement("use_ref"));
     ...
     * }
     */
    public static final OfBoolean use_ref$layout() {
        return use_ref$LAYOUT;
    }

    private static final long use_ref$OFFSET = 48;
     ...
     * }
     */
    public static final long use_ref$offset() {
        return use_ref$OFFSET;
    }
     ...
     * }
     */
    public static boolean use_ref(MemorySegment struct) {
        return struct.get(use_ref$LAYOUT, use_ref$OFFSET);
    }
     ...
     * }
     */
    public static void use_ref(MemorySegment struct, boolean fieldValue) {
        struct.set(use_ref$LAYOUT, use_ref$OFFSET, fieldValue);
    }
