...
public class whisper_full_params {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        WhisperLib.C_INT.withName("strategy"),
        WhisperLib.C_INT.withName("n_threads"),
        WhisperLib.C_INT.withName("n_max_text_ctx"),
        WhisperLib.C_INT.withName("offset_ms"),
        WhisperLib.C_INT.withName("duration_ms"),
        WhisperLib.C_BOOL.withName("translate"),
        WhisperLib.C_BOOL.withName("no_context"),
        WhisperLib.C_BOOL.withName("no_timestamps"),
        WhisperLib.C_BOOL.withName("single_segment"),
        WhisperLib.C_BOOL.withName("print_special"),
        WhisperLib.C_BOOL.withName("print_progress"),
        WhisperLib.C_BOOL.withName("print_realtime"),
        WhisperLib.C_BOOL.withName("print_timestamps"),
        WhisperLib.C_BOOL.withName("token_timestamps"),
        MemoryLayout.paddingLayout(3),
        WhisperLib.C_FLOAT.withName("thold_pt"),
        WhisperLib.C_FLOAT.withName("thold_ptsum"),
        WhisperLib.C_INT.withName("max_len"),
        WhisperLib.C_BOOL.withName("split_on_word"),
        MemoryLayout.paddingLayout(3),
        WhisperLib.C_INT.withName("max_tokens"),
        WhisperLib.C_BOOL.withName("debug_mode"),
        MemoryLayout.paddingLayout(3),
        WhisperLib.C_INT.withName("audio_ctx"),
        WhisperLib.C_BOOL.withName("tdrz_enable"),
        MemoryLayout.paddingLayout(3),
        WhisperLib.C_POINTER.withName("suppress_regex"),
        WhisperLib.C_POINTER.withName("initial_prompt"),
        WhisperLib.C_BOOL.withName("carry_initial_prompt"),
        MemoryLayout.paddingLayout(7),
        WhisperLib.C_POINTER.withName("prompt_tokens"),
        WhisperLib.C_INT.withName("prompt_n_tokens"),
        MemoryLayout.paddingLayout(4),
        WhisperLib.C_POINTER.withName("language"),
        WhisperLib.C_BOOL.withName("detect_language"),
        WhisperLib.C_BOOL.withName("suppress_blank"),
        WhisperLib.C_BOOL.withName("suppress_nst"),
        MemoryLayout.paddingLayout(1),
        WhisperLib.C_FLOAT.withName("temperature"),
        WhisperLib.C_FLOAT.withName("max_initial_ts"),
        WhisperLib.C_FLOAT.withName("length_penalty"),
        WhisperLib.C_FLOAT.withName("temperature_inc"),
        WhisperLib.C_FLOAT.withName("entropy_thold"),
        WhisperLib.C_FLOAT.withName("logprob_thold"),
        WhisperLib.C_FLOAT.withName("no_speech_thold"),
        whisper_full_params.greedy.layout().withName("greedy"),
        whisper_full_params.beam_search.layout().withName("beam_search"),
        MemoryLayout.paddingLayout(4),
        WhisperLib.C_POINTER.withName("new_segment_callback"),
        WhisperLib.C_POINTER.withName("new_segment_callback_user_data"),
        WhisperLib.C_POINTER.withName("progress_callback"),
        WhisperLib.C_POINTER.withName("progress_callback_user_data"),
        WhisperLib.C_POINTER.withName("encoder_begin_callback"),
        WhisperLib.C_POINTER.withName("encoder_begin_callback_user_data"),
        WhisperLib.C_POINTER.withName("abort_callback"),
        WhisperLib.C_POINTER.withName("abort_callback_user_data"),
        WhisperLib.C_POINTER.withName("logits_filter_callback"),
        WhisperLib.C_POINTER.withName("logits_filter_callback_user_data"),
        WhisperLib.C_POINTER.withName("grammar_rules"),
        WhisperLib.C_LONG_LONG.withName("n_grammar_rules"),
        WhisperLib.C_LONG_LONG.withName("i_start_rule"),
        WhisperLib.C_FLOAT.withName("grammar_penalty"),
        WhisperLib.C_BOOL.withName("vad"),
        MemoryLayout.paddingLayout(3),
        WhisperLib.C_POINTER.withName("vad_model_path"),
    ...
    public static class greedy {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            WhisperLib.C_INT.withName("best_of")
        ).withName("$anon$551:9");
    ...
    public static class beam_search {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            WhisperLib.C_INT.withName("beam_size"),
            WhisperLib.C_FLOAT.withName("patience")
        ).withName("$anon$555:9");
