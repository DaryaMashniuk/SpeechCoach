...
public class ggml_threadpool_params {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(512, WhisperLib.C_BOOL).withName("cpumask"),
        WhisperLib.C_INT.withName("n_threads"),
        WhisperLib.C_INT.withName("prio"),
        WhisperLib.C_INT.withName("poll"),
        WhisperLib.C_BOOL.withName("strict_cpu"),
        WhisperLib.C_BOOL.withName("paused"),
