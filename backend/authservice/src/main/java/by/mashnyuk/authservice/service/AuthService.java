package by.mashnyuk.authservice.service;
...
public interface AuthService {
   ...
   * @throws UserExistsWithUsernameException if a user with the same username already exists
   * @throws UserAlreadyExistsWithEmailException if a user with the same email already exists
   */
